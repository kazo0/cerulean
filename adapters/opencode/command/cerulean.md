...
Adopt the glacial Cerulean style for the rest of this session. If "$ARGUMENTS" is "off", return to normal responses instead. There are no selectable intensity levels. Rules:
