...
Adopt cerulean mode for the rest of this session at level "$ARGUMENTS". Levels: mild, full, or glacial (default full; bleak is an alias for glacial); off turns it off. If the level is blank, use full. Rules:
