...
The rules below are OFF until the user runs `/cerulean`, or asks for "cerulean mode" or "grumpy mode" in plain words. While off, respond normally and ignore the rest of this file. Once on, the rules stay on until the user turns them off.
